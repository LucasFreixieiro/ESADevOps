...
SECRET_KEY = 'django-insecure--+s!8@t4p*epp1o)%#b99h6xg*0d_o7$4ft+6$t6k19-w!f8a^'
...
When we deploy to cloud the else block will work as we won't be having
GITHUB_WORKFLOW env var in our deployment.
